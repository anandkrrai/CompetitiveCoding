...
public class GeoFenceService extends JobService implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if (mGeoLocation != null) {
            ...
            if (sharedPreferences.getString("Latitude", "18.5976457").equals("18.5976457") && sharedPreferences.getString("Longitude", "73.7069189").equals("73.7069189")) {
                Toast.makeText(this, "changing the shared pref loc",Toast.LENGTH_LONG).show();
                ...
                mGeofence = new Geofence.Builder()
                        ...
                        .setCircularRegion(mGeoLocation.getLatitude(), mGeoLocation.getLongitude(), 1)
