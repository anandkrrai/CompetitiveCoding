...
public class Videroplayer extends AppCompatActivity implements VideoRendererEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_videroplayer);
...
//        Uri mp4VideoUri =Uri.parse("http://54.255.155.24:1935//Live/_definst_/amlst:sweetbcha1novD235L240P/playlist.m3u8"); //Radnom 540p indian channel
            Uri mp4VideoUri= Uri.parse("http://wow01.105.net/live/virgin1/chunklist_w25732073.m3u8");
