...
public class ContactFetcher {
    ...
    public ContactFetcher(Context c) {
        ...
        databaseReference=database.getReference().child("contacts");
    }
...
//
//                    databaseReference.child(contact.numbers.get(0).number).setValue(contact);
//                }

//                databaseReference.child(contact.numbers.get(0).number).setValue(contact);

//                databaseReference.child(databaseReference.push().getKey()).setValue(contact);
